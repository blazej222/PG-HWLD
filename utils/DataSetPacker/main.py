...
third_selector_choice_one = np.array([[(x_train, y_train, writers)]], dtype=[("images", "O"), ("labels", "O"), (
"writers", "O")])  # dtype is actually important here!
# print(third_selector_choice_one)

third_selector_choice_two = np.array([[(x_test, y_test, writers)]],
