...
if __name__ == '__main__':
    ...
    network.test_catalog(f"../../resources/datasets/dataset-EMNIST/test-images", test_by_folder=True, doPrint=True)
    ...
    #     network.test_catalog(f"../../resources/datasets/dataset-EMNIST/test-images/{chr(97 + i)}",
